...
$fid=$_POST['frm_id'] ;
mysqli_query($con,"update Query set admin_remark='$adminremark' where id='$fid'");
echo '<script>alert("Query has been updated.")</script>';
}
?>
<!DOCTYPE html>
<html>
...
<div class="page-container row"> 
  ...
  <div class="page-content">
    ...
    <div class="clearfix"></div>
    <div class="content">
      <a href="#" class="active">View Queries</a>
        <h3>Query Support</h3>
      </div>
      
     <?php $rt=mysqli_query($con,"select * from Query order by id desc");
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">query_id <?php echo $_SESSION['sid']=$row['query_id'];?></span> - Created on <?php echo $row['posting_date'];?>
