          ...
          <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
            <div class="tiles blue added-margin">
              <div class="tiles-body">
                ...
                <?php $ret=mysqli_query($con,"select * from Query where email_id='".$_SESSION['login']."'");
				$num=mysqli_num_rows($ret);
				?>
                <div class="heading"> <span class="animate-number" data-value="<?php echo $num;?>" data-animation-duration="1200">0</span>|
                 <a href="#" style="color:#FFF"> View order </a></div>
          ...
          <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
            <div class="tiles green added-margin">
              <div class="tiles-body">
                ...
                <a href="#" style="color:#FFF">Make order</a>
                 </div>
                <div class="progress transparent progress-small no-radius">
          ...
          <div class="col-md-3 col-sm-6">
            <div class="tiles purple added-margin">
              <div class="tiles-body">
                ...
                <div class="row-fluid">
                  <div class="heading"> <span class="fa fa-ticket"></span>
                  <a href="#" style="color:#FFF">Request order</a>
                   </div>
                  <div class="progress transparent progress-white progress-small no-radius">
